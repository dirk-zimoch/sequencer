...
epicsShareFunc void seq_efSet(SS_ID, evflag);
epicsShareFunc seqBool seq_efTest(SS_ID, evflag);
epicsShareFunc seqBool seq_efClear(SS_ID, evflag);
epicsShareFunc seqBool seq_efTestAndClear(SS_ID, evflag);
